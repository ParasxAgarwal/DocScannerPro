...
private val LightColorScheme = lightColorScheme(
    ...
    onPrimary = NeutralOnPrimary,
    primaryContainer = NeutralPrimaryContainer,
    onPrimaryContainer = NeutralOnPrimaryContainer,
    secondary = NeutralSecondary,
    onSecondary = NeutralOnSecondary,
    secondaryContainer = NeutralSecondaryContainer,
    onSecondaryContainer = NeutralOnSecondaryContainer,
